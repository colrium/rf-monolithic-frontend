					...
					{actionButtons.includes("download") ? (
						<Tooltip title="Download">
							<IconButton
								...
								sx={{ color: indigo[400] }}
								onClick={event =>
									handleActionClick(event, "download")
								}
								size="large">
								<GetApp />
							</IconButton>
				...
				<Fragment>
					{actionButtons.includes("refresh") && (
						<Tooltip title="Refresh">
							<IconButton
								...
								sx={{ color: indigo[400] }}
								onClick={event =>
									handleActionClick(event, "refresh")
								}
								size="large">
								<Badge
									badgeContent={refreshBadgeCount}
									color="error">
									<Cached />
								</Badge>
							</IconButton>
					...
					{actionButtons.includes("import") && (
						<Tooltip title="Import">
							<IconButton
								...
								sx={{ color: amber[600] }}
								onClick={event =>
									handleActionClick(event, "import")
								}
								size="large">
								<CloudUpload />
							</IconButton>
					...
					{actionButtons.includes("bulkEdit") && (
						<Tooltip title="Bulk Edit">
							<IconButton
								...
								sx={{ color: indigo[500] }}
								onClick={event =>
									handleActionClick(event, "bulkEdit")
								}
								size="large">
								<Edit />
							</IconButton>
					...
					{actionButtons.includes("create") && (
						<Tooltip title="Create">
							<IconButton
								...
								onClick={event =>
									handleActionClick(event, "create")
								}
								size="large">
								<AddCircle />
							</IconButton>
					...
					{actionButtons.includes("filter") && (
						<FormControl variant="outlined">
							<InputLabel htmlFor="universal-filter">
								Filter
							</InputLabel>
							<OutlinedInput
								id="universal-filter"
