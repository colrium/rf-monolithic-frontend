...
const CustomAutocomplete = (props) => {
	const { className, disabled, isMulti, loading, onChange, label, required, variant, margin, size, max, excludeValidation, min, validate, validator, onValidityChange, helperText, onOpen, onClose, touched, invalid, isClearable, error, value, options, freeSolo, popupIcon, renderOption, ...rest } = props
			...
			if (JSON.isJSON(options)) {
				...
				options.map((option, cursor) => {
					if (JSON.isJSON(option)) {
						...
						else if (Function.isFunction(renderOption)) {
