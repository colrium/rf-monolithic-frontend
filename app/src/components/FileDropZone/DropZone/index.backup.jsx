...
const CustomDropZone = React.forwardRef((props, ref) => {
    const {
        acceptedFiles,
        activeColor,
        className,
    ...
    return (
        <Dropzone accept={acceptedFiles.join(",")}
        onDrop = { handleOnDrop }
        onDropRejected = { handleDropRejected }
        acceptClassName = { "bg-green-100" }
        rejectClassName = { "bg-red-100" }
        maxSize = { maxFileSize }>
            {({
                getRootProps,
                getInputProps,
                ...
                <Box
                className={`p-2 border rounded w-full ${className ? className : ""}`}
                sx = {
                    {
                ...
                <GridItem xs = { 12 } > {
                    ...
                    color = { isDragActive ? activeColor : "text.secondary" }
                    fullWidth
                                    paragraph >
                                    {
                        String.isString(
                    ...
                    {
                        showPreviews && ( <PreviewList className = "p-0"
                    ...
                    showAlerts && ( <Snackbar anchorOrigin = {
                            {
                                vertical: "bottom",
                                horizontal: "right",
                            }
                        ...
                        <MuiAlert onClose = { onCloseSnackbar }
