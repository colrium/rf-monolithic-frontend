...
const Fielder = (props) => {
    ...
    const [imageSrc, { ref: imageRef }] = useLazyImage((avatar ? (/*ApiService.getAttachmentFileUrl(avatar)*/ "https://api.realfield.io/attachments/download/" + avatar) : ApiService.endpoint("/public/img/avatars/" + icon + ".png")), ApiService.endpoint("/public/img/avatars/" + icon + ".png"));
