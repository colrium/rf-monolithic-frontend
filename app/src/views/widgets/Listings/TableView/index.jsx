...
import { withApiDataProvider, useApiData } from "contexts/ApiData";
...
const TableView = props => {
	...
	const loadData = useCallback(() => {
		if (!!defination && defination?.endpoint) {
				...
				// ApiService.get(defination.endpoint, {params: {...query}})
				get({params: {...query}})
					.then(res => {
...
export default compose(connect(mapStateToProps, { openDialog, closeDialog }))(withApiDataProvider(TableView));
