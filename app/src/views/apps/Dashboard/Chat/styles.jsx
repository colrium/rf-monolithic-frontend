	...
	createStyles({
		...
		"@keyframes typing_loader_line": {
			"0%": {
				...
				boxShadow:
					"12px 0px 0px 0px rgba(0,0,0,0.2),  24px 0px 0px 0px rgba(0,0,0,0.2)",
			},
			"25%": {
				backgroundColor: theme.palette.action.hover,
				boxShadow:
					"12px 0px 0px 0px rgba(0,0,0,2), 24px 0px 0px 0px rgba(0,0,0,0.2)",
			},
			"75%": {
				backgroundColor: theme.palette.text.disabled,
				boxShadow:
					"12px 0px 0px 0px rgba(0,0,0,0.2), 24px 0px 0px 0px rgba(0,0,0,2)",
			},
		},
		typing_loader: {
