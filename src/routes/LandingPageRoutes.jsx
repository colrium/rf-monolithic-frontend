	...
	render() {
		return (
			<Switch>
				...
				<Route exact path={"/catalog".toUriWithLandingPagePrefix()} component={Catalog} />
				<Route exact path={"/catalog/:id".toUriWithLandingPagePrefix()} component={CatalogItem} />
				<Route exact path={"/request-quote".toUriWithLandingPagePrefix()} component={Order} />	
				<Route exact path={"/cart".toUriWithLandingPagePrefix()} component={Cart} />
				<Route exact path={"/checkout".toUriWithLandingPagePrefix()} component={Checkout} />
				<Route exact path={"/thankyou".toUriWithLandingPagePrefix()} component={Thankyou} />					
