						...
						<GridItem xs={12} sm={12} md={4}>
							<Card color="transparent" style={{ width: "100%" }}>
								<CardBody
									...
									vinset
								>
									<Typography bold doublespaced variant="h5">
										Surveys
									</Typography>
									<Typography doublespaced>
										Lorem ipsum dolor sit amet, consectetur
										adipiscing elit. Sed vulputate est vitae
										est facilisis gravida. Curabitur elit
										felis, finibus eget finibus id, pharetra
										sit amet neque. Integer sit amet pretium
										libero. Nulla in risus id nisi rutrum
										hendrerit.
									</Typography>
									<Button
										color="primary"
						...
						<GridItem xs={12} sm={12} md={4} className="toppadded">
							<Card color="transparent" style={{ width: "100%" }}>
								<Typography bold color="accent" variant="h3">
									"Finally traditional research at online
									prices, it couldn't come soon enough"
								</Typography>
