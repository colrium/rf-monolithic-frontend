		...
		return (
			<Grid container className="relative min-h-screen">
				<Grid item  xs={12} sm={10} md={8} className="m-auto">
					...
					<Typography variant="h1" className="w-full text-center text-gray-500">
						{" "}
						Thank you
					</Typography>
					<Typography variant="subtitle2" className="w-full text-center mt-8">
						{" "}
...
export default connect(mapStateToProps, { resetEcommerce })(Page)
