		...
		return (
					<GridContainer className="relative min-h-screen">
						<GridItem xs={12} sm={10} md={8} className="m-auto" >
							<Typography variant="h1" className="w-full text-center mb-16"> <ThankyouIcon className="text-6xl m-auto text-gray-500" /></Typography>
							<Typography variant="h1" className="w-full text-center text-gray-500"> Thank you</Typography>
							<Typography variant="subtitle2" className="w-full text-center mt-8"> You order was placed. </Typography>
						</GridItem>
					</GridContainer>
		);
	}
...
export default withRoot(connect(mapStateToProps, {resetEcommerce})(Page));
