	...
	render() {
		...
		return (
			<GridContainer className="p-0 m-0 inline-block h-auto">
				...
				<GridContainer className="p-0 m-0">
					<GridItem xs={12} md={6}>
						<Button onClick={onComplete} className="sm:w-full md:w-auto " color="primary" round ><Check /> Lets get started</Button>	
					</GridItem>

					<GridItem xs={12} md={6}>
						<Button onClick={onCancel} className="sm:w-full md:w-auto float-right" color="secondary" round><Check /> Request Proposal</Button>	
					</GridItem>
				</GridContainer>
