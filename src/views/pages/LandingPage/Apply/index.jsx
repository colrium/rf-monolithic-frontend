...
class Page extends React.Component {
	...
	render() {
		...
		return (
					<GridContainer style={{minHeight: "90vh"}} alignItems="center" justify="center">
							...
							<GridContainer alignItems="center" justify="center">
								<GridItem xs={12} sm={12} md={10}>
									<Typography variant="body1">
										Its great to meet you! Please complete all fields within the form below to register your interest in becoming a Real Fielder. All applications will be reviewed and you will be contacted by our Team with further details. Thanks! We look forward to working with you!!
									</Typography>
								</GridItem>
							</GridContainer>
