...
import BlueBg4 from "assets/img/realfield/Blue_BG/4_Blue_BG.png";
			...
			<Section className={"p-0 min-h-screen"} id="why-us" >
				<GridContainer className={"p-0"}>
					<GridItem xs={12} md={12} className="p-0 pb-8">
						...
						<GridContainer className={"p-0"}>	
							<GridItem xs={12} className="p-0 px-2 md:px-12 mb-2 flex flex-row items-center">
								<img src={BlueBg1} className="w-12 h-12 mx-4 md:mx-12" />
								<Typography variant="subtitle2">High quality empirical data</Typography>							
							</GridItem>

							<GridItem xs={12} className="p-0 px-2 md:px-12 mb-2 flex flex-row items-center">
								<img src={BlueBg2} className="w-12 h-12 mx-4 md:mx-12" />
								<Typography variant="subtitle2">Real time results</Typography>							
							</GridItem>

							<GridItem xs={12} className="p-0 px-2 md:px-12 mb-2 flex flex-row items-center">
								<img src={BlueBg3} className="w-12 h-12 mx-4 md:mx-12" />
								<Typography variant="subtitle2">Ethical sourcing</Typography>							
							</GridItem>

							<GridItem xs={12} className="p-0 px-2 md:px-12 mb-2 flex flex-row items-center">
								<img src={BlueBg4} className="w-12 h-12 mx-4 md:mx-12" />
					...
					<GridItem xs={12} className="p-0 flex flex-row items-center py-4">
						<img src={LogoChevron} className="w-4 h-4 mr-4" />
					...
					<GridItem xs={12} className="flex flex-col items-center  py-4" id="ethical-principles">
						<Link
											...
											className="block"
										>
							<Button className={"primary-text  font-semibold"} classes={{label: "capitalize text-3xl"}}>Learn more about our Ethical Principles</Button>
					...
					<GridContainer className={"p-0 mb-4"}>	
							<GridItem xs={12} className="p-0 px-2 py-4 md:px-12 mb-2 flex flex-row items-center">
								<img src={GreenBg1} className="w-12 h-12 mx-4 md:mx-12" />
							...
							<GridItem xs={12} className="p-0 px-2 py-4 md:px-12 mb-2 flex flex-row items-center">
								<img src={GreenBg2} className="w-12 h-12 mx-4 md:mx-12" />
							...
							<GridItem xs={12} className="p-0 px-2 py-4 md:px-12 mb-2 flex flex-row items-center">
								<img src={GreenBg3} className="w-12 h-12 mx-4 md:mx-12" />
