...
const Mobile = props => {
	...
	const { setValue, getValues, formState } = usePersistentForm(formConfig)
	...
	return (
		<Box {...rest}>
			<MobileStepper
				...
				nextButton={
					<Button size="small" onClick={handleNext} disabled={!isValid || indexOfstage === stagekeys.length - 1}>
						Next
						{theme.direction === "rtl" ? <KeyboardArrowLeft /> : <KeyboardArrowRight />}
					</Button>
				}
				backButton={
					<Button size="small" onClick={handlePrevious} disabled={indexOfstage === 0}>
