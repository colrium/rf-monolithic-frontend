					...
					<GridItem xs={12} md={11} className={"p-0"}>
						...
						<GridContainer className={"p-0"}>
							<GridItem xs={12} sm={12} className={"p-0 py-2 pb-4"}>
								...
								<Typography variant="subtitle2">
									It’s great to meet you! Please complete all fields required within the form below to register your interest in becoming a Real Fielder. All applications will be reviewed, and you will be contacted by our Team with further details. Thanks! We look forward to working with you soon!
								</Typography>
							</GridItem>
						</GridContainer>

						<GridContainer className={"p-0"}>
							{content === "form" && <GridItem xs={12} className={"p-0"}>
								<BaseForm
							...
							{content === "acknowledgement" && <GridItem xs={12} className={"p-0 py-48 flex flex-col justify-center items-center"}>
								<Typography variant="subtitle1" color="primary" paragraph>Your application has been submitted successfully. Thankyou for your interest in working with us.</Typography>
								<Typography variant="body1" paragraph>A member of our will get in touch with you about your application as soon as possible  </Typography>
							</GridItem>}
						</GridContainer>
					</GridItem>
				</GridContainer>
