	...
	render() {
		return (
							<Card elevation={0} outlineColor="#cfd8dc">
								<CardHeader avatar={
						          <Avatar aria-label={definations.surveys.label} style={{background:definations.surveys.color}}>
								...
								<CardContent >
									<GridContainer className="p-0 m-0">
										<VectorMap {...world} color="#CCCCCC" colors={{Kenya: "#004d3e"}} labels={{Kenya: "Total : 1"}} enableSelect={false}/>
									</GridContainer>
								</CardContent>
								<CardActions>
									<GridContainer className="p-0 m-0">
											<GridItem xs={12}>
												<Typography variant="body2"> {definations.surveys.label} by Country Overview </Typography>
											</GridItem>													
									</GridContainer>
								</CardActions>
