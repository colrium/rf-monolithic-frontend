            ...
            <GridContainer direction="row" justify="center" alignItems="center" className="h-full"  >
                <GridItem className="h-full" xs={12} md={8} lg={6}>
                    <GridContainer className="h-full" direction="column" justify="center" alignItems="center">
                        <GridItem xs={12}>
                            <Typography color="error" className="text-4xl" variant="h1" center fullWidth>
                                {icon}
                            </Typography>
                        </GridItem>
                        <GridItem xs={12}>
                            <Typography color={color} variant="h3" center fullWidth>
                                {title}
							</Typography>
                        </GridItem>
...
AccessDenied.defaultProps = {
    title: "Access Denied!",
    description: "Sorry! Access to this resource has been denied since you lack required priviledges. <br /> Please contact the system administrator for further details.",
    icon: <WarningRoundedIcon className="text-6xl" />,
    color: "grey",
    link: ("home").toUriWithDashboardPrefix(),
};

export default withRoot(AccessDenied);
