		...
		return (
			<div className={classes.mapWrapper} id={"animated-chevron-map-"+mapIdSuffix}>
				...
				{/*popup && <motion.div
						...
						onClick={() => this.setState(prevState => ({presenceOpen: !prevState.presenceOpen}))}
						layoutId={this.popUpIdPrefix+"-"+activePoint}
						style={{
					...
					>
						{!presenceOpen && <Typography variants="body1" className="text-xl uppercase font-extrabold">{popup.message}</Typography>}
						{presenceOpen && <div className="flex flex-col">
							<Typography variants="body1" className="text-sm normal-case font-bold" paragraphg>{popup.presenceTitle}</Typography>
							<Typography variants="body2" className="text-sm normal-case">{popup.presenceContent}</Typography>
					</div>}
				...
				>
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 0,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 1,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 2,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 3,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 4,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 5,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 6,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 7,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 8,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 9,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 10,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 11,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 12,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 13,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 14,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 15,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 16,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 17,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 18,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 19,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 20,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 21,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 22,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 23,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 24,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 25,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 26,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 27,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 28,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 29,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 30,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 31,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 32,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 33,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 34,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 35,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 36,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 37,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 38,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 39,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 40,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 41,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 42,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 43,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 44,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 45,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 46,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 47,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 48,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 49,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 50,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 51,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 52,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 53,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 54,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 55,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 56,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 57,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 58,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 59,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 60,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 61,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 62,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 63,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 64,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 65,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 66,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 67,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 68,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 69,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 70,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 71,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 72,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 73,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 74,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 75,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 76,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 77,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 78,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 79,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 80,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 81,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 82,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 83,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 84,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 85,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 86,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 87,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 88,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 89,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 90,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 91,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 92,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 93,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 94,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 95,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 96,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 97,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 98,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 99,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 100,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 101,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 102,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 103,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 104,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 105,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 106,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 107,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 108,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 109,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 110,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 111,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 112,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 113,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 114,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 115,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 116,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 117,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 118,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 119,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 120,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 121,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 122,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 123,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 124,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 125,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 126,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 127,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 128,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 129,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 130,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 131,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 132,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 133,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 134,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 135,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 136,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 137,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 138,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 139,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 140,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 141,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 142,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 143,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 144,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 145,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 146,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 147,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 148,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 149,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 150,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 151,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 152,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 153,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 154,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 155,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 156,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 157,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 158,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 159,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 160,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 161,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 162,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 163,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 164,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 165,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 166,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 167,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 168,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 169,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 170,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 171,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 172,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 173,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 174,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 175,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 176,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 177,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 178,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 179,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 180,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 181,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 182,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 183,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 184,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 185,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 186,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 187,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 188,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 189,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 190,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 191,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 192,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 193,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 194,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 195,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 196,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 197,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 198,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 199,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 200,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 201,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 202,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 203,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 204,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 205,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 206,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 207,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 208,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 209,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 210,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 211,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 212,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 213,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 214,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 215,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 216,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 217,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 218,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 219,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 220,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 221,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 222,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 223,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 224,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 225,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 226,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 227,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 228,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 229,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 230,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 231,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 232,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 233,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 234,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 235,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 236,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 237,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 238,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 239,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 240,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 241,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 242,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 243,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 244,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 245,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 246,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 247,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 248,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 249,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 250,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 251,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 252,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 253,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 254,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 255,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 256,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 257,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 258,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 259,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 260,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 261,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 262,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 263,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 264,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 265,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 266,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 267,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 268,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 269,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 270,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 271,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 272,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 273,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 274,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 275,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 276,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 277,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 278,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 279,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 280,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 281,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 282,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 283,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 284,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 285,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 286,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 287,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 288,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 289,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 290,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 291,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 292,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 293,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 294,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 295,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 296,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 297,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 298,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 299,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 300,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 301,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 302,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 303,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 304,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 305,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 306,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 307,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 308,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 309,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 310,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 311,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 312,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 313,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 314,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 315,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 316,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 317,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 318,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 319,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 320,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 321,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 322,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 323,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 324,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 325,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 326,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 327,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 328,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 329,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 330,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 331,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 332,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 333,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 334,
						})}
					>
						<polygon
					...
					<g
						className={classNames({
							[classes.point]: true,
							active: activePoint >=0 && animations[activePoint].polygonIndex === 335,
						})}
					>
						<polygon
