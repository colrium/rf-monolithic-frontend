...
class LocationSearchInput extends React.Component {
	...
	render() {
		const { className, controlPosition, onLeftBtnClick } = this.props;
		...
		return (
			...
			>
				<div
					className={
						"py-1 px-2 sm:w-full md:w-5/6 lg:w-4/6 " +
						(className ? className : "")
					}
				>
					<Paper
						...
						ref={this.suggestionsMenuAnchorRef}
					>
						{ Function.isFunction(onLeftBtnClick) && <IconButton
