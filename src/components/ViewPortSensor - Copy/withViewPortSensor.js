...
function withViewPortSensor(TargetComponent, options, config = { disconnectOnLeave: false }) {
	...
	InViewport.displayName = `withViewPortSensor(${name})`;
