...
function ViewPortSensor(props) {
	...
	let { className, children, offset, onViewportVisibilityChange, placeholder, placeholderType } = state; 
	...
	// Hook
	function useOnScreen(ref, rootMargin = '0px', onEnterViewPort, onExitViewPort ) {
