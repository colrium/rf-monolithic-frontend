...
function ImageControl({ configuration, defaultConfiguration }) {
	...
	return (
		<React.Fragment>
			...
			>
				<List component="nav" aria-label={editor.translate("controls.image.labels.insertOptions")}>
					<ListItem
						button
						onClick={() => {
			...
			<ByUrlDialog onSubmit={handleSubmitImage} onClose={() => setIsUrlDialogOpened(false)} open={isUrlDialogOpened} />
