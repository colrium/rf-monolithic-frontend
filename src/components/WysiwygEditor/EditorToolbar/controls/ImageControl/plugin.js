...
const EditorMedia = ({ contentState, block }) => {
	...
	if (type === entities.IMAGE) {
		...
		return <EditorImage src={src} width={width} height={height} block={block} contentState={contentState} />
	}
...
const EditorImage = ({ src, width, height, contentState, block }) => {
	...
	return (
		<React.Fragment>
			...
			>
				<ButtonGroup size="small" aria-label={editor.translate("controls.image.labels.editOptions")}>
					<Button onClick={ev => imageAlign(ev, "left")} title={editor.translate("controls.image.actions.alignLeft")}>
						<ArrowLeftIcon />
						<ImageIcon />
					</Button>
					<Button onClick={ev => imageAlign(ev, "center")} title={editor.translate("controls.image.actions.alignCenter")}>
						<ArrowLeftIcon />
						<ImageIcon />
						<ArrowRightIcon />
					</Button>
					<Button onClick={ev => imageAlign(ev, "right")} title={editor.translate("controls.image.actions.alignRight")}>
						<ImageIcon />
						<ArrowRightIcon />
					</Button>
					<Button
					...
					<Button onClick={removeImage} title={editor.translate("controls.image.actions.remove")}>
						<DeleteIcon />
					</Button>
				</ButtonGroup>
			</Popover>
