...
function UploadDialog({ open, onClose, onSubmit, uploadCallback }) {
	...
	let dropAreaContent = <Typography variant="subtitle1">{editor.translate("controls.image.labels.dropImageHere")}</Typography>
	...
	return (
		<Dialog open={open} onClose={onClose} onEnter={resetForm}>
			<form onSubmit={handleSubmit}>
				<DialogContent>
					<input ref={inputFileRef} type="file" accept="image/*" onChange={handleInputFileChange} style={{ display: "none" }} />
