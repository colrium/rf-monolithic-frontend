...
class AuthApiService {
	...
	async login(data) {
		...
		return await this.apiInstance.post('login', data)
									.then(response => {
										let resobj = {
														err: false,
														body: response.data,
	...
	async profile(data={}) {
		let that = this;
		return await this.apiInstance.get('profile', data)
	...
	async update_profile(data={}) {
		let that = this;
		return await this.apiInstance.post('profile', data)
									.then(function (response) {
										let resobj = {
														err: false,
														body: response.data,
	...
	async signup(data) {
		let that = this;
		return await this.apiInstance.post('signup', data)
									.then(function (response) {
										let resobj = {
														err: false,
														body: response.data,
	...
	async logout() {
		let that = this;
		return await this.endpoint().get('logout')
									.then(function (response) {
										Auth.getInstance().removeAuthToken();
										let resobj = {
														err: false,
	...
	async logout_all() {
		let that = this;
		return await this.endpoint().get('logout/all')
									.then(function (response) {
										let resobj = {
														err: false,
														body: response.data,
	...
	async forgotPassword(data) {
		let that = this;
		return await this.apiInstance.post('forgot-password', data)
									.then(function (response) {
										let resobj = {
														err: false,
														body: response.data,
	...
	async resetPassword(data) {
		let that = this;
		return await this.apiInstance.post('change-password', data)
									.then(function (response) {
										let resobj = {
														err: false,
														body: response.data,
	...
	async verifyAccount(data) {
		let that = this;
		return await this.apiInstance.post('verify-account', data)
									.then(function (response) {
										let resobj = {
														err: false,
														body: response.data,
	...
	async get_auth_token(){
		let that = this;
		return await this.apiInstance.get('token')
									.then(function (response) {
										let resobj = {
														err: false,
														body: response.data,
